...
class RecipeView extends View {
  ...
  addHandlerUpdateServings(handlerFunction) {
    this._parentElem.addEventListener('click', function (e) {
      ...
      const newServings = parseInt(btn.dataset.servings);
    ...
    <div class="recipe__details">
      ...
      <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
          <button class="btn--tiny btn-servings btn--decrease-servings" data-servings="${
            recipe.servings - 1
          }">
            <svg>
          ...
          <button class="btn--tiny btn-servings btn--increase-servings" data-servings="${
            recipe.servings + 1
          }">
            <svg>
